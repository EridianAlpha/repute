...
export default function ClaimPrizeButton({ wagmiProviderConfig, setPrizePot, setVoteFinished }) {
    ...
    const handleTransaction = async () => {
        try {
            ...
            const txObject = {
                ...
                abi: reputeAbi,
                functionName: "settleVoteResults",
                args: [1, 1],
    ...
    }, [isConfirming, isConfirmed, error, hash, transactionState, chainId, toast, setPrizePot, triggerTxToast])
    ...
    return (
        ...
        >
            ...
            {!transactionState.isWaitingForSignature && !transactionState.isConfirming && (
                <HStack>
                    <Text>Claim your $50 prize and reputation now</Text>
                </HStack>
            )}
        </Button>
    )
